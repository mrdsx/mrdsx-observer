...
from src.utils.projects_reports import projects_reports_range, validate_projects_reports
    ...
    def _normalize_services_reports(
        ...
        for daily_report in daily_reports:
            for project_id, project_report in daily_report.projects.items():
                ...
                for service_name, service_report in project_report.items():
                    ...
                    if existing_service_reports is None:
                        services_reports[service_name] = ServiceReportsDTO(
                            daily_reports={}
                        )
