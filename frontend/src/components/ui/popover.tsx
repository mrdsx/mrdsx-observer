  ...
  return (
    <PopoverPortal>
      <PopoverPrimitive.Content
        ...
        class={cx(
          "bg-popover text-sm text-popover-foreground data-expanded:animate-in data-closed:animate-out data-closed:fade-out-0 data-expanded:fade-in-0 data-closed:zoom-out-95 data-expanded:zoom-in-95 z-50 w-72 origin-(--kb-popover-content-transform-origin) rounded-md border p-2 shadow-md outline-hidden",
